...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            @component('gentelella.panel')
                ...
                <form action="{{route('admin.qnastore',['type'=>'notice'])}}" class="form-horizontal form-label-left" method="post">
                    @csrf
                    @method('post')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="content" name="content" id="content" required="required" class="form-control col-md-7 col-xs-12" style="height:250px;">
                        </div>
                    </div>
