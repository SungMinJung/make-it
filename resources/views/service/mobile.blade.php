        ...
        <div class="col-10">
            ...
            <div id="tab1" class="tabcontent current">
                <div class="row">
                    ...
                    <div class="col-9" style="position:relative;right:10px;">
                        <p>
                            <span style="font-size:25px;color:#3d3d3d;font-weight:lighter;">기본 모바일 어플리케이션 제작</span><br>
                            <span style="font-size:40px;font-weight:bold;color:#3d3d3d;">Basic Mobile Application</span>
                        </p>
                    </div>
            ...
            <div id="tab2" class="tabcontent">
                <div class="row">
                    ...
                    <div class="col-9" style="position:relative;right:10px;">
                        <p>
                            <span style="font-size:25px;color:#3d3d3d;font-weight:lighter;">일반 모바일 어플리케이션 제작</span><br>
                            <span style="font-size:40px;font-weight:bold;color:#3d3d3d;">General Mobile Application</span>
                        </p>
                    </div>
                    <div class="col-4" style="position:relative;right:10px;padding-top:30px;">
                        <span style="font-size:30px;font-weight:bold;color:#3d3d3d;">5,000,000원</span><br>
                    </div>
                    <div class="row">
                        <div class="col-9">
                            <span style="font-size:21px;color:#3d3d3d;position:relative;top:40px;">
                ...
                <div class="row">
                    ...
                    <div class="col-9" style="position:relative;right:10px;">
                        <p>
                            ...
                            <span style="font-size:40px;font-weight:bold;color:#3d3d3d;">Shopping Mall Mobile Application</span>
                        </p>
                    </div>
                    <div class="col-4" style="position:relative;right:10px;padding-top:30px;">
                        <span style="font-size:30px;font-weight:bold;color:#3d3d3d;">5,000,000원</span><br>
            ...
            <div id="tab4" class="tabcontent">
                <div class="row">
                    ...
                    <div class="col-9" style="position:relative;right:10px;">
                        <p>
                            <span style="font-size:25px;color:#3d3d3d;font-weight:lighter;">맞춤형 모바일 어플리케이션 제작</span><br>
                            <span style="font-size:40px;font-weight:bold;color:#3d3d3d;">Custom Mobile Application</span>
                        </p>
                    </div>
                    <div class="col-4" style="position:relative;right:10px;padding-top:30px;">
            ...
            <div id="tab5" class="tabcontent">
                <div class="row">
                    ...
                    <div class="col-9" style="position:relative;right:10px;">
                        <p>
                            <span style="font-size:25px;color:#3d3d3d;font-weight:lighter;">프리미엄 모바일 어플리케이션 제작</span><br>
                            <span style="font-size:40px;font-weight:bold;color:#3d3d3d;">Premium Mobile Application</span>
                        </p>
                    </div>
                    <div class="col-4" style="position:relative;right:10px;padding-top:30px;">
