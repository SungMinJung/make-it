    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-5" style="margin-top:190px;">
                <span class="servicesmall font-noto-eng" style="color:#ffffff;">Responsive Website Development</span><br>
                <span class="servicebig font-noto-kr" style="color:#ffffff;">반응형 웹 개발 및 제작</span>
            </div>
        </div>
        <div class="row">
            <div class="col-5"></div>
        ...
        <div class="row">
            ...
            <div class="col-2" style="margin-top:5px;margin-bottom:15px;">
                <span class="font-noto-eng" style="color:#ffffff;font-size:17px;font-weight:600">Responsive Web Category</span>
            </div>
        </div>
        <div class="row">
            <div class="col-5"></div>
        ...
        <div class="col-10">
            ...
            <div id="tab1" class="tabcontent current">
                <div class="row">
                    ...
                    <div class="col-9" style="position:relative;right:10px;">
                        <p>
                            <span class="sertop">기본 반응형 웹 제작</span><br>
                            <span class="sertopbot">Basic Responsive Web</span>
                        </p>
                    </div>
                    <div class="col-4" style="position:relative;right:10px;padding-top:30px;">
                        <span class="sermid">3,500,000원</span><br>
            ...
            <div id="tab2" class="tabcontent">
                <div class="row">
                    ...
                    <div class="col-9" style="position:relative;right:10px;">
                        <p>
                            <span class="sertop">일반 반응형 웹 제작</span><br>
                            <span class="sertopbot">General Responsive Web</span>
                        </p>
                    </div>
                    <div class="col-4" style="position:relative;right:10px;padding-top:30px;">
                ...
                <div class="row">
                    ...
                    <div class="col-9" style="position:relative;right:10px;">
                        <p>
                            ...
                            <span class="sertopbot">Shopping Mall Responsive Web</span>
                        </p>
                    </div>
                    <div class="col-4" style="position:relative;right:10px;padding-top:30px;">
                        <span class="sermid">10,000,000원</span><br>
            ...
            <div id="tab4" class="tabcontent">
                <div class="row">
                    ...
                    <div class="col-9" style="position:relative;right:10px;">
                        <p>
                            <span class="sertop">맞춤형 반응형 웹 제작</span><br>
                            <span class="sertopbot">Custom Responsive Web</span>
                        </p>
                    </div>
                    <div class="col-4" style="position:relative;right:10px;padding-top:30px;">
            ...
            <div id="tab5" class="tabcontent">
                <div class="row">
                    ...
                    <div class="col-9" style="position:relative;right:10px;">
                        <p>
                            <span class="sertop">프리미엄 반응형 웹 제작</span><br>
                            <span class="sertopbot">Premium Responsive</span>
                        </p>
                    </div>
                    <div class="col-4" style="position:relative;right:10px;padding-top:30px;">
                        <span class="sermid">20,000,000원</span><br>
                        <span class="sermidblue">*모바일웹 제작 추가시 800,000원 추가</span>
                    </div>
                    <div class="row">
                        <div class="col-8">
